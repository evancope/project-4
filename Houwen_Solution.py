...
from functions import houwen
import parameters as P
import matplotlib.pyplot as plt
import time

t_i = P.tspan_houwen[0]
t_f = P.tspan_houwen[1]
y0 = P.y0_houwen


solution45 = ode.RK45(houwen,t_i,y0,t_f,atol = P.tolerance_houwen)
solution113 = ode.LSODA(houwen,t_i,y0,t_f,atol = P.tolerance_houwen)
solution15s = ode.BDF(houwen,t_i,y0,t_f,atol = P.tolerance_houwen)
...
plt.title('RK45 solution to houwen function')
plt.legend()
plt.grid()
plt.show()
...
plt.plot(y1_values45,y2_values45,\
          label = 'y1,y2', color = 'red')
plt.title('RK45 phase plot for houwen function')
plt.legend()
plt.grid()
plt.show()
...
plt.plot(t113, y2_values113,\
          label = 'y2', color = 'green')
plt.title('ODE113 solution to houwen function')
plt.legend()
plt.grid()
plt.show()
...
plt.title('ODE113 phase plot for houwen function')
plt.legend()
plt.grid()
plt.show()
...
plt.plot(t15s, y2_values15s,\
          label = 'y2', color = 'green')
plt.title('BDF solution to houwen function')
plt.legend()
plt.grid()
plt.show()
...
plt.title('BDF phase plot for houwen function')
plt.legend()
plt.grid()
plt.show()