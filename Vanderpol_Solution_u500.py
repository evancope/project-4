...
from functions import vanderpol500
import parameters as P
import matplotlib.pyplot as plt
import time

t_i = P.tspan_vanderpole[1][0]
t_f = P.tspan_vanderpole[1][1]
y0 = P.y0_vanderpole


solution45 = ode.RK45(vanderpol500,t_i,y0,t_f,atol = P.tolerance_vanderpole)
solution113 = ode.LSODA(vanderpol500,t_i,y0,t_f,atol = P.tolerance_vanderpole)
solution15s = ode.BDF(vanderpol500,t_i,y0,t_f,atol = P.tolerance_vanderpole)
